 ...
 */
const getImgUrlBySize = (src, size) => {
  let wz = '';
  if (src.indexOf('.jpg')) {
    srcArray = src.split('.jpg');
    wz = 'jpg';
  } else if (src.indexOf('.png')) {
    srcArray = src.split('.png');
    wz = 'png';
  } else if (src.indexOf('.gif')) {
    srcArray = src.split('.gif');
    wz = 'gif';
  } else if (src.indexOf('.jpeg')) {
    srcArray = src.split('.jpeg');
    wz = 'jpeg';
  }
  if (srcArray.length == 2) {
    src = `${srcArray[0]}_${size}.${wz}${srcArray[1]}`;
  }
  return src;
}
